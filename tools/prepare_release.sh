...
echo ""
echo "🚀 Tag $VERSION pushed! Codemagic should now start the production build."
echo "📄 Draft release notes saved to: exports/release_notes_draft.txt"
echo ""
echo "Next Steps:"
echo "1. Verify the build in Codemagic."
echo "2. Once published, run: ./tools/finish_release.sh"
